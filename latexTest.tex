...
{\normalfont\huge\bfseries\centering\color[HTML]{42428a}}
...
\begin{table}[H]
	...
	\begin{tabular}{|l|l|}
		\hline
		\multicolumn{1}{|c|}{Motor explorer 2D}                                     & \multicolumn{1}{c|}{Motor Explorer web VR}                                                                          \\ \hline
...
\begin{table}[H]
	...
	\begin{tabular}{cc}
		\hline
		\multicolumn{1}{|c|}{\textbf{Role}} & \multicolumn{1}{c|}{\textbf{Description}}           \\ \hline
