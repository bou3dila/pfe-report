...
\begin{table}[H]
	...
	\begin{tabular}{ccc}
		...
		\multicolumn{1}{|c|}{\begin{tabular}[c]{@{}c@{}}I as a user would like to see a loader\\ at the start of the app\end{tabular}}                        & \multicolumn{1}{c|}{13}                & \multicolumn{1}{c|}{2}                \\ \hline
		\multicolumn{1}{|c|}{\begin{tabular}[c]{@{}c@{}}I as a user would like to have panels\\ containing information about the motors\end{tabular}}       & \multicolumn{1}{c|}{14}                & \multicolumn{1}{c|}{4}                \\ \hline
		\multicolumn{1}{|c|}{\begin{tabular}[c]{@{}c@{}}I as a user would like to have a panel\\ containing information about the dynamometer\end{tabular}} & \multicolumn{1}{c|}{15}                & \multicolumn{1}{c|}{4}                \\ \hline
		\multicolumn{1}{|c|}{I as a user would like to have an instructions panel }                                                                                               & \multicolumn{1}{c|}{16}                & \multicolumn{1}{c|}{4}                \\ \hline
...
\begin{tabular}{|l|l|l|l|}
	...
	\multicolumn{1}{|c|}{\cellcolor[HTML]{6200C9}{\color[HTML]{FFFFFF} User story}}              & \multicolumn{1}{c|}{\cellcolor[HTML]{6200C9}{\color[HTML]{FFFFFF} Description}}                                                                  & \multicolumn{1}{c|}{\cellcolor[HTML]{6200C9}{\color[HTML]{FFFFFF} Priority}} & \multicolumn{1}{c|}{\cellcolor[HTML]{6200C9}{\color[HTML]{FFFFFF} Estimation}} \\ \hline
	\begin{tabular}[c]{@{}l@{}}I as a user would like to see a control \\ panel\end{tabular}     & \begin{tabular}[c]{@{}l@{}}User gains access to a control panel that contains\\ interactive buttons and sliders\end{tabular}                     & 1                                                                            & 1                                                                              \\ \hline
	I as a user would like to set the load                                                       & \begin{tabular}[c]{@{}l@{}}User gets to manipulate a slider that helps him set\\ the value of the Load\end{tabular}                              & 2                                                                            & 3                                                                              \\ \hline
	I as a user would like to set the speed                                                      & \begin{tabular}[c]{@{}l@{}}User gets to manipulate a slider that helps him set\\ the value of the Speed\end{tabular}                             & 3                                                                            & 3                                                                              \\ \hline
	I as a user would like to set the voltage                                                    & \begin{tabular}[c]{@{}l@{}}User gets to manipulate a slider that helps him set \\ the value of the Voltage\end{tabular}                          & 4                                                                            & 3                                                                              \\ \hline
	\begin{tabular}[c]{@{}l@{}}I as a user would like to turn the test\\ on and off\end{tabular} & \begin{tabular}[c]{@{}l@{}}Add a visible on and off button for the user to \\ initiate the testing\end{tabular}                                  & 5                                                                            & 2                                                                              \\ \hline
	\begin{tabular}[c]{@{}l@{}}I as a user would like to have a result \\ menu\end{tabular}      & \begin{tabular}[c]{@{}l@{}}On the control panel add a section of visible results\\  for the test which will be updated in real time\end{tabular} & 6                                                                            & 2                                                                              \\ \hline
\end{tabular}
\caption{Sprint one backlog}
\end{table}
\section{Analysis and conception}

The next section will contain detailed information on each functionality of the sprint.

\subsection{Actors identification}
The only actor is the user
...
\begin{figure}[H]
	\includegraphics[scale=0.9, frame]{controlPanelUseCase.png}
	\caption{Use case diagram "Control Panel"}
\end{figure}
\begin{table}[H]
	\begin{center}
		\begin{tabular}{|
			...
			\hline
			{\color[HTML]{FFFFFF} Use case}       &  Control Panel                                                                                                                                                     \\ \hline
			{\color[HTML]{FFFFFF} Main actor}     &  user                                                                                                                                                           \\ \hline
			{\color[HTML]{FFFFFF} Pre-condition}  &  Can’t be accessible until user places a motor                                                                                                                                                \\ \hline
			{\color[HTML]{FFFFFF} Post Condition} &  Shows the interactive sliders and buttons                                                                                                                                  \\ \hline
			{\color[HTML]{FFFFFF} Description}    &  {\color[HTML]{000000} \begin{tabular}[c]{@{}l@{}}At first it will be a screen asking user to place a motor after user conducts the action the panel \\ transforms into a multiple button / sliders composition revealing the controls to the user\end{tabular}}                                                                                   \\ \hline
			{\color[HTML]{FFFFFF} Exception}      &  {\color[HTML]{000000} \begin{tabular}[c]{@{}l@{}}The run button wont work until the user presses the on/off buttone\end{tabular}} \\ \hline
		\end{tabular}
	\end{center}
	\caption{Use case diagram "Control Panel"}
\end{table}

\subsubsection{Load Setting}

\begin{figure}[H]
	\includegraphics[scale=0.9, frame]{LoadUseCase.png}
	\caption{Use case diagram "Load Setting"}
\end{figure}
\begin{table}[H]
	\begin{center}
		\begin{tabular}{|
				>{\columncolor[HTML]{6200C9}}l |l|}
			\hline
			{\color[HTML]{FFFFFF} Use case}       &  Load setting                                                                                                                                                     \\ \hline
			{\color[HTML]{FFFFFF} Main actor}     &  user                                                                                                                                                           \\ \hline
			{\color[HTML]{FFFFFF} Pre-condition}  &  User must enable the control panel                                                                   \\ \hline
			{\color[HTML]{FFFFFF} Post Condition} & Slider maximum and minimum value correspond to the motor inserted                                                                                                                                  \\ \hline
			{\color[HTML]{FFFFFF} Description}    &  {\color[HTML]{000000} \begin{tabular}[c]{@{}l@{}}After placing a motor the load slider will allow user to set the value needed to conduct the test \end{tabular}}                                                                                   \\ \hline
...
\subsubsection{Voltage Setting}

\begin{figure}[H]
	\includegraphics[scale=0.9, frame]{VoltageUseCase.png}
	\caption{Use case diagram "Voltage Setting"}
\end{figure}
\begin{table}[H]
	\begin{center}
		\begin{tabular}{|
				>{\columncolor[HTML]{6200C9}}l |l|}
			\hline
			{\color[HTML]{FFFFFF} Use case}       &  Voltage setting                                                                                                                                                     \\ \hline
			{\color[HTML]{FFFFFF} Main actor}     &  user                                                                                                                                                           \\ \hline
			{\color[HTML]{FFFFFF} Pre-condition}  &  User must enable the control panel                                                                   \\ \hline
			{\color[HTML]{FFFFFF} Post Condition} & Slider maximum and minimum value correspond to the motor inserted                                                                                                                                  \\ \hline
			{\color[HTML]{FFFFFF} Description}    &  {\color[HTML]{000000} \begin{tabular}[c]{@{}l@{}}After placing a motor the load slider will allow user to set the value needed to conduct the test \end{tabular}}                                                                                   \\ \hline
...
\begin{table}[H]
	\begin{center}
		\begin{tabular}{|
			...
			{\color[HTML]{FFFFFF} Pre-condition}  &  User must enable the control panel                                                                   \\ \hline
			{\color[HTML]{FFFFFF} Post Condition} & Slider maximum and minimum value correspond to the motor inserted                                                                                                                                  \\ \hline
			{\color[HTML]{FFFFFF} Description}    &  {\color[HTML]{000000} \begin{tabular}[c]{@{}l@{}}After placing a motor the voltage slider will allow user to set the value needed to conduct the test \end{tabular}}                                                                                   \\ \hline
			{\color[HTML]{FFFFFF} Exception}      &  \\ \hline
		\end{tabular}
	\end{center}
	\caption{Use case diagram "Load Setting"}
...
\subsubsection{Speed Setting}

\begin{figure}[H]
	\includegraphics[scale=0.9, frame]{SpeedUseCase.png}
	\caption{Use case diagram "Speed Setting"}
\end{figure}
\begin{table}[H]
	\begin{center}
		\begin{tabular}{|
				>{\columncolor[HTML]{6200C9}}l |l|}
			\hline
			{\color[HTML]{FFFFFF} Use case}       &  Speed setting                                                                                                                                                     \\ \hline
			{\color[HTML]{FFFFFF} Main actor}     &  user                                                                                                                                                           \\ \hline
			{\color[HTML]{FFFFFF} Pre-condition}  &  User must enable the control panel                                                                   \\ \hline
			{\color[HTML]{FFFFFF} Post Condition} & Slider maximum and minimum value correspond to the motor inserted                                                                                                                                  \\ \hline
			{\color[HTML]{FFFFFF} Description}    &  {\color[HTML]{000000} \begin{tabular}[c]{@{}l@{}}After placing a motor the speed slider will allow user to set the value needed to conduct the test \end{tabular}}                                                                                   \\ \hline
			{\color[HTML]{FFFFFF} Exception}      &  \\ \hline
		\end{tabular}
	\end{center}
	\caption{Use case diagram "Speed Setting"}
...
\subsubsection{Start/End the test}

\begin{figure}[H]
	\includegraphics[scale=0.9, frame]{StartEndUseCase.png}
	\caption{Use case diagram "Start/End the test"}
\end{figure}
\begin{table}[H]
	\begin{center}
		\begin{tabular}{|
				>{\columncolor[HTML]{6200C9}}l |l|}
			\hline
			{\color[HTML]{FFFFFF} Use case}       &  Start/End                                                                                                                                                     \\ \hline
			{\color[HTML]{FFFFFF} Main actor}     &  user                                                                                                                                                           \\ \hline
			{\color[HTML]{FFFFFF} Pre-condition}  &  User must enable the control panel and hit the on  button                                                                  \\ \hline
			{\color[HTML]{FFFFFF} Post Condition} & User can use the button again to end the current test                                                                                                                                  \\ \hline
			{\color[HTML]{FFFFFF} Description}    &  {\color[HTML]{000000} \begin{tabular}[c]{@{}l@{}}This button allows for easy control to turn on and off the testing in hand  \end{tabular}}                                                                                   \\ \hline
			{\color[HTML]{FFFFFF} Exception}      &  \\ \hline
		\end{tabular}
	\end{center}
	\caption{Use case diagram "Start/End the test"}
...
\begin{figure}[H]
	\includegraphics[scale=0.9, frame]{ResultMenuUseCase.png}
	\caption{Use case diagram "Results Menu"}
\end{figure}
\begin{table}[H]
	\begin{center}
		\begin{tabular}{|
				>{\columncolor[HTML]{6200C9}}l |l|}
			\hline
			{\color[HTML]{FFFFFF} Use case}       &  Results menu                                                                                                                                                     \\ \hline
			{\color[HTML]{FFFFFF} Main actor}     &  user                                                                                                                                                           \\ \hline
			{\color[HTML]{FFFFFF} Pre-condition}  &  User must enable the control panel and conduct a test                                                                \\ \hline
			{\color[HTML]{FFFFFF} Post Condition} & Values on this menu will dynamically be updated during the test                                                                                                                                  \\ \hline
			{\color[HTML]{FFFFFF} Description}    &  {\color[HTML]{000000} \begin{tabular}[c]{@{}l@{}}This menu is where the user can view the results , it is automatically updated during the test \\ with the motor status and each value needed   \end{tabular}}                                                                                   \\ \hline
			{\color[HTML]{FFFFFF} Exception}      &  \\ \hline
		\end{tabular}
	\end{center}
	\caption{Use case diagram "Results menu"}
...
\begin{tabular}{|l|l|l|l|}
	...
	\rowcolor[HTML]{6200C9} 
	\multicolumn{1}{|c|}{\cellcolor[HTML]{6200C9}{\color[HTML]{FFFFFF} User story}}                     & \multicolumn{1}{c|}{\cellcolor[HTML]{6200C9}{\color[HTML]{FFFFFF} Description}}                                                    & \multicolumn{1}{c|}{\cellcolor[HTML]{6200C9}{\color[HTML]{FFFFFF} Priority}} & \multicolumn{1}{c|}{\cellcolor[HTML]{6200C9}{\color[HTML]{FFFFFF} Estimation}} \\ \hline
	I   as a user would like to have a motor menu                                                       & \begin{tabular}[c]{@{}l@{}}User gets a visible motor shelf   that contains \\ all the motors\end{tabular}                          & 7                                                                            & 2                                                                              \\ \hline
	I   as a user would like to see a dynamometer                                                       & \begin{tabular}[c]{@{}l@{}}User gets the dynamometer with   the \\ on/off switch button\end{tabular}                               & 8                                                                            & 2                                                                              \\ \hline
	I as a user would like to see a   workbench                                                         & \begin{tabular}[c]{@{}l@{}}User obtains a visible workbench in which \\ he places the motor\end{tabular}                           & 9                                                                            & 2                                                                              \\ \hline
	\begin{tabular}[c]{@{}l@{}}I   as a user would like to interact with \\ the work-bench\end{tabular} & \begin{tabular}[c]{@{}l@{}}User has the drag/drop function   to interact \\ with the visual aspect of the application\end{tabular} & 10                                                                           & 8                                                                              \\ \hline
\end{tabular}
...
\begin{table}[H]
	...
	\begin{tabular}{|
			>{\columncolor[HTML]{6200C9}}l |l|}
		\hline
		{\color[HTML]{FFFFFF} Use case}       &  Motor menu                                                                                                                                                     \\ \hline
		{\color[HTML]{FFFFFF} Main actor}     &  user                                                                                                                                                           \\ \hline
		{\color[HTML]{FFFFFF} Pre-condition}  &  User is loaded-in                                                                                                                                                \\ \hline
		{\color[HTML]{FFFFFF} Post Condition} &  User can view the motor menu                                                                                                                                    \\ \hline
		{\color[HTML]{FFFFFF} Description}    &  Shows a set of motors that the user can pick from to run the test                                                                                               \\ \hline
		{\color[HTML]{FFFFFF} Exception}      &  {\color[HTML]{000000} \begin{tabular}[c]{@{}l@{}}Only 1 motor can be picked at a time picking another one will \\ result in placing the first motor to its original place\end{tabular}} \\ \hline
	\end{tabular}
\end{center}
\caption{Use case diagram "Motor Menu"}
\end{table}

\subsubsection{Dynamometer}

\begin{figure}[H]
	\includegraphics[scale=0.9, frame]{dynamometerUseCase.PNG}
...
\begin{table}[H]
	\begin{center}
		\begin{tabular}{|
			...
			{\color[HTML]{FFFFFF} Description}    & {\color[HTML]{000000} \begin{tabular}[c]{@{}l@{}}User will have access to the work-bench where he can place the motor\\ to conduct the test  pressed  \end{tabular}}                                                                                               \\ \hline
...
\begin{table}[H]
	\begin{center}
		\begin{tabular}{|
				>{\columncolor[HTML]{6200C9}}l |l|}
			\hline
			{\color[HTML]{FFFFFF} Use case}       & Drag and Drop                                                                                                                                                     \\ \hline
			{\color[HTML]{FFFFFF} Main actor}     &  user                                                                                                                                                           \\ \hline
			{\color[HTML]{FFFFFF} Pre-condition}  &  User must be loaded-in                                                                                                                                                \\ \hline
			{\color[HTML]{FFFFFF} Post Condition} &  User can drag and drop motors onto the workbench                                                                                                                                   \\ \hline
			{\color[HTML]{FFFFFF} Description}    &  {\color[HTML]{000000} \begin{tabular}[c]{@{}l@{}}User gets a set of visible hands where he can use to drag and drop components \\ from the motor menu to the workbench and interact with the control panel \end{tabular}}                                                                                               \\ \hline
			{\color[HTML]{FFFFFF} Exception}      &  \\ \hline
		\end{tabular}
	\end{center}
	\caption{Use case diagram "Drag and Drop"}
...
\section{Conclusion}
This chapter explained the visual aspect of our application as we move toward the next sprint where the calculations and tests can be conducted with visible results.
...
\begin{tabular}{|l|l|l|l|}
	...
	\rowcolor[HTML]{6200C9} 
	\multicolumn{1}{|c|}{\cellcolor[HTML]{6200C9}{\color[HTML]{FFFFFF} User story}}                                 & \multicolumn{1}{c|}{\cellcolor[HTML]{6200C9}{\color[HTML]{FFFFFF} Description}}                                            & \multicolumn{1}{c|}{\cellcolor[HTML]{6200C9}{\color[HTML]{FFFFFF} Priority}} & \multicolumn{1}{c|}{\cellcolor[HTML]{6200C9}{\color[HTML]{FFFFFF} Estimation}} \\ \hline
	\begin{tabular}[c]{@{}l@{}}I  as a user would like to see the motors \\  running\end{tabular}                   & \begin{tabular}[c]{@{}l@{}}User   will have rotating animation indicating that \\ the test is being conducted\end{tabular} & 11                                                                           & 2                                                                              \\ \hline
	\begin{tabular}[c]{@{}l@{}}I as a user would like to hear sounds\\    indicating   motor status\end{tabular}    & \begin{tabular}[c]{@{}l@{}}User   will have sounds indiciating that the test is \\ being conducted\end{tabular}            & 11                                                                           & 2                                                                              \\ \hline
	\begin{tabular}[c]{@{}l@{}}I as a user would like to have   accurate \\ calculations for AC motors\end{tabular} & \begin{tabular}[c]{@{}l@{}}Values   menu would be updated by the test results \\ for AC motors calculations\end{tabular}   & 12                                                                           & 5                                                                              \\ \hline
	\begin{tabular}[c]{@{}l@{}}I as a user would like to have   accurate\\ calculations for DC motors\end{tabular}  & \begin{tabular}[c]{@{}l@{}}Values   menu would be updated by the test results \\ for AC motors calculations\end{tabular}   & 12                                                                           & 5                                                                              \\ \hline
\end{tabular}
\caption{Sprint three backlog}
\end{table}

\section{Analysis and conception}

The next section contains the details and the use case diagrams on each of the user story motioned above

\subsection{a.	Actors identification}
This sprint has one actor: User

\subsection{Use case diagrams}
\begin{figure}[H]
	\includegraphics[scale=0.7, frame]{SprintThreeUseCase.PNG}
	\caption{Use case diagram "Sprint Three"}
\end{figure}
...
\subsubsection{Animations}
\begin{figure}[H]
	\includegraphics[scale=0.7, frame]{SoundsUseCase.PNG}
	\caption{Use case diagram "Sounds"}
\end{figure}
...
\begin{table}[H]
	\begin{center}
		\begin{tabular}{|
				>{\columncolor[HTML]{6200C9}}l |l|}
			\hline
			{\color[HTML]{FFFFFF} Use case}       & Sounds                                                                                                                                                     \\ \hline
			{\color[HTML]{FFFFFF} Main actor}     &  user                                                                                                                                                           \\ \hline
			{\color[HTML]{FFFFFF} Pre-condition}  &  User is loaded in the app                                                           \\ \hline
			{\color[HTML]{FFFFFF} Post Condition} &  Every interaction with the application has its own sounds                                                                                                                                    \\ \hline
			{\color[HTML]{FFFFFF} Description}    & \begin{tabular}[c]{@{}l@{}}Each sound is set to indicate the different phases of the test or \\ if the motors is being placed or not. \end{tabular}                                                                                           \\ \hline
			{\color[HTML]{FFFFFF} Exception}      &   \\ \hline
		\end{tabular}
	\end{center}
	\caption{Use case diagram "Sounds"}
...
\subsubsection{AC motors calculations}
\begin{figure}[H]
	\includegraphics[scale=0.6, frame]{ACcalculationsUseCase.PNG}
	\caption{Use case diagram "AC motors calculations"}
\end{figure}
...
\begin{table}[H]
	\begin{center}
		\begin{tabular}{|
				>{\columncolor[HTML]{6200C9}}l |l|}
			\hline
			{\color[HTML]{FFFFFF} Use case}       & AC calculations                                                                                                                                                     \\ \hline
			{\color[HTML]{FFFFFF} Main actor}     &  user                                                                                                                                                           \\ \hline
			{\color[HTML]{FFFFFF} Pre-condition}  &  User must place an AC type Motor                                                          \\ \hline
			{\color[HTML]{FFFFFF} Post Condition} &  User must conduct a test sounds                                                                                                                                    \\ \hline
			{\color[HTML]{FFFFFF} Description}    & \begin{tabular}[c]{@{}l@{}}During and after the testing the value menu will be updated with the results needed. \end{tabular}                                                                                           \\ \hline
			{\color[HTML]{FFFFFF} Exception}      &   \\ \hline
		\end{tabular}
	\end{center}
	\caption{Use case diagram "AC motors calculations"}
...
\subsubsection{DC motors calculations}
\begin{figure}[H]
	\includegraphics[scale=0.6, frame]{DCcalculationsUseCase.PNG}
	\caption{Use case diagram "DC motors calculations"}
\end{figure}
...
\begin{table}[H]
	\begin{center}
		\begin{tabular}{|
				>{\columncolor[HTML]{6200C9}}l |l|}
			\hline
			{\color[HTML]{FFFFFF} Use case}       & DC calculations                                                                                                                                                     \\ \hline
			{\color[HTML]{FFFFFF} Main actor}     &  user                                                                                                                                                           \\ \hline
			{\color[HTML]{FFFFFF} Pre-condition}  &  User must place an DC type Motor                                                          \\ \hline
			{\color[HTML]{FFFFFF} Post Condition} &  User must conduct a test sounds                                                                                                                                    \\ \hline
			{\color[HTML]{FFFFFF} Description}    & \begin{tabular}[c]{@{}l@{}}During and after the testing the value menu will be updated with the results needed. \end{tabular}                                                                                           \\ \hline
			{\color[HTML]{FFFFFF} Exception}      &   \\ \hline
		\end{tabular}
...
\begin{table}[H]
	\begin{tabular}{|l|l|l|l|}
		...
		\rowcolor[HTML]{6200C9} 
		\multicolumn{1}{|c|}{\cellcolor[HTML]{6200C9}{\color[HTML]{FFFFFF} User story}}                                                     & \multicolumn{1}{c|}{\cellcolor[HTML]{6200C9}{\color[HTML]{FFFFFF} Description}}                                                  & \multicolumn{1}{c|}{\cellcolor[HTML]{6200C9}{\color[HTML]{FFFFFF} Priority}} & \multicolumn{1}{c|}{\cellcolor[HTML]{6200C9}{\color[HTML]{FFFFFF} Estimation}} \\ \hline
		\begin{tabular}[c]{@{}l@{}}I   as a user would like to see a loader\\  at the start of the app\end{tabular}                         & \begin{tabular}[c]{@{}l@{}}User will have a loading screen   when first loading \\ the application\end{tabular}                  & 13                                                                           & 2                                                                              \\ \hline
		\begin{tabular}[c]{@{}l@{}}I   as a user would like to have panels\\ containing   information about the\\ motors\end{tabular}       & \begin{tabular}[c]{@{}l@{}}Upon hovering on a motor you will   obtain detailed\\ information about that motor\end{tabular}       & 14                                                                           & 4                                                                              \\ \hline
		\begin{tabular}[c]{@{}l@{}}I   as a user would like to have a panel\\ containing   information about the\\ dynamometer\end{tabular} & \begin{tabular}[c]{@{}l@{}}Upon hovering on the dynamometer   you will obtain all \\ the information on that device\end{tabular} & 15                                                                           & 4                                                                              \\ \hline
		\begin{tabular}[c]{@{}l@{}}I   as a user would like to have an\\ instructions panel\end{tabular}                                    & \begin{tabular}[c]{@{}l@{}}User has instructions to easily   guide him throughout \\ the application\end{tabular}                & 16                                                                           & 4                                                                              \\ \hline
	\end{tabular}
\end{table}

\section{Analysis and conception}
The next part will have the detailed information on the sprint user stories.
\subsection{Actors identification}
the only actor in this sprint is the user.
\subsection{Use case diagrams}
\begin{figure}[H]
	\includegraphics[scale=0.8, frame]{SprintFourUseCase.PNG}
	\caption{Use case diagram "Sprint Four Use Case"}
\end{figure}

\subsubsection{The loader}
\begin{figure}[H]
	\includegraphics[scale=0.8, frame]{LoaderUseCase.PNG}
	\caption{Use case diagram "Sprint Four Use Case"}
\end{figure}
...
\begin{table}[H]
	\begin{center}
		\begin{tabular}{|
				>{\columncolor[HTML]{6200C9}}l |l|}
			\hline
			{\color[HTML]{FFFFFF} Use case}       & The loader                                                                                                                                                     \\ \hline
			{\color[HTML]{FFFFFF} Main actor}     &  user                                                                                                                                                           \\ \hline
			{\color[HTML]{FFFFFF} Pre-condition}  &  User launches the application                                                          \\ \hline
			{\color[HTML]{FFFFFF} Post Condition} &  User sees loading progress on his screen                                                                                                                                \\ \hline
			{\color[HTML]{FFFFFF} Description}    & \begin{tabular}[c]{@{}l@{}}Upon starting the application the user will get a loading screen \\ showing him the progress of the loading \end{tabular}                                                                                           \\ \hline
			{\color[HTML]{FFFFFF} Exception}      &   \\ \hline
		\end{tabular}
	\end{center}
	\caption{Use case diagram "The Loader"}
\end{table}


\subsubsection{Motor panels}
\begin{figure}[H]
	\includegraphics[scale=0.8, frame]{MotorPanelsUseCase.PNG}
	\caption{Use case diagram "Motor Panels Use Case"}
\end{figure}
...
\begin{table}[H]
	\begin{center}
		\begin{tabular}{|
				>{\columncolor[HTML]{6200C9}}l |l|}
			\hline
			{\color[HTML]{FFFFFF} Use case}       & Motor panels                                                                                                                                                     \\ \hline
			{\color[HTML]{FFFFFF} Main actor}     &  user                                                                                                                                                           \\ \hline
			{\color[HTML]{FFFFFF} Pre-condition}  &  User launches the application                                                          \\ \hline
			{\color[HTML]{FFFFFF} Post Condition} &  User can see the details on each motor                                                                                                                             \\ \hline
			{\color[HTML]{FFFFFF} Description}    & \begin{tabular}[c]{@{}l@{}}Upon hovering on the motor user gets a visual readable text that shows \\ him the details of that motor \end{tabular}                                                                                           \\ \hline
			{\color[HTML]{FFFFFF} Exception}      &   \\ \hline
		\end{tabular}
	\end{center}
	\caption{Use case diagram "Motor panels"}
\end{table}

\subsubsection{Dynamometer panel}
\begin{figure}[H]
	\includegraphics[scale=0.8, frame]{DynamometerPanelUseCase.PNG}
	\caption{Use case diagram "Motor Panels Use Case"}
\end{figure}
...
\begin{table}[H]
	\begin{center}
		\begin{tabular}{|
				>{\columncolor[HTML]{6200C9}}l |l|}
			\hline
			{\color[HTML]{FFFFFF} Use case}       & Dynamometer panel                                                                                                                                                    \\ \hline
			{\color[HTML]{FFFFFF} Main actor}     &  user                                                                                                                                                           \\ \hline
			{\color[HTML]{FFFFFF} Pre-condition}  &  User launches the application                                                          \\ \hline
			{\color[HTML]{FFFFFF} Post Condition} &  User can read the information about dynamomemter                                                                                                                           \\ \hline
			{\color[HTML]{FFFFFF} Description}    & \begin{tabular}[c]{@{}l@{}}Upon hovering on the dynamometer the user will obtain detailed description\\ on what is the dynamometer . \end{tabular}                                                                                           \\ \hline
			{\color[HTML]{FFFFFF} Exception}      &   \\ \hline
		\end{tabular}
	\end{center}
	\caption{Use case diagram "Motor panels"}
...
\begin{table}[H]
	\begin{center}
		...
		\end{tabular}
	\end{center}
	\caption{Use case diagram "Dynamometer panels"}
\end{table}
